...
const index = ({
    ...
    return <>
        {toolBarConfig?.useToolBar &&
            <div className={toolBarConfig?.toolBarStyle}>
                {toolBarConfig.inline?.useInlineStyle &&
                    <div id='inlineStyling' className={`flex flex-wrap items-center justify-between gap-3 ${toolBarConfig.inline?.inlineStyle} `}>
                ...
                {toolBarConfig.alignment?.useAlignment &&
                ...
                {toolBarConfig.emojis?.useEmojis &&
                ...
                {toolBarConfig.anchorLink?.useAnchorLink &&
                ...
                {toolBarConfig.embedCode?.useEmbedCode &&
                ...
                {toolBarConfig.deleteAllText?.useDeleteAllText &&
                    <div>
                        <button onClick={() => handleDeleteAllText(textAreaRef)} >deleteAllText</button>
                    </div>
                }
                {toolBarConfig.history?.useHistory &&
